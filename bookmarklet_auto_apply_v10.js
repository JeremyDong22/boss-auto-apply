...
(function () {
    ...
    panel.innerHTML = `
        <div style="position:fixed;top:80px;right:20px;z-index:99999;
            ...
            <div style="font-size:16px;font-weight:bold;margin-bottom:12px">Boss 自动投递 v10</div>
